    ...
    public class Game
    {
        ...
        public void Step (string command)
        {
            ...
            switch (command)
            {
                ...
                case "10": PrintManual(); Console.ReadLine(); break;
        ...
        private void PrintManual()
        {
            string manual = "Игра в студента:\n" +
                              ...
                              "Спать -5 ед.\n" +
                              "\n" +
                              "Поход в столовую: При походе в столовую студент может повысить сытость и настроение в обмен на деньги\n" +
                              ...
                              "\n" +
                              "Поход в игровой клуб: При походе в игровой клуб студент может повысить свое настроение в обмен на деньги\n" +
                              ...
                              "\n" +
                              "Учеба: Во время учебы у студента повышается опыт (от 0 до +10 ед.) (как повезет)\n" +
                              ...
                              "Список вакансий:\n" +
                              "дворник: Зарплата: 500 , Расчетный период: 10 , минимальный опыт: 0 \n" +
